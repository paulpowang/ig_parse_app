...
**IG Parse** is a photo sharing app using Parse as its backend.
...
1. how to post image data to mangodb?
2. where and how I can find mangoDB API and use it to support me complete this project?

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/paulpowang/ig_parse_app/blob/master/ig_app_01.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' /><img src='https://github.com/paulpowang/ig_parse_app/blob/master/ig_app_02.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
there was only a video tutorial video for head start, and then I have to research a lot more for figure out how to use mangoDB api to get the functions work. Unfortunately, I didn't get enough information to complete this project. I stuck on send image data to mangoDB, because I don't know what api I can use to get it to work. But I will try to work on it in the future. 
